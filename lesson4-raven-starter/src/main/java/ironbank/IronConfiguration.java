...
public class IronConfiguration {
     ...
     **/
    /**
     * Update from 01.10.2020 - Смысл разницы в подходах Евгения Борисова и Кирилла Толкачева в том, что при способе Евгения Борисова,
     *  Spring будет инджектить с помощью рефлексии один бин в другой(а рефлексия является дорогой процедурой),
     *  а при способе Кирилла Толкачева мы сами сетим с помощью конструктора один бин в другой не юзая рефлексию.
     */
